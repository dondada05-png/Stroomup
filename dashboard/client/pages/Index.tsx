          ...
          <div className="container mx-auto px-4 text-center">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="mb-16 max-w-4xl mx-auto">
                ...
                {/* Stroomcoins Feature */}
                <div className="bg-brand-light border border-brand-primary/20 rounded-2xl p-6 max-w-2xl mx-auto">
                  <div className="flex items-center justify-center gap-3 mb-4">
                    <div className="w-8 h-8 bg-brand-primary rounded-full flex items-center justify-center">
                      <span className="text-white font-bold text-sm">SC</span>
                    </div>
                    <h3 className="text-xl font-bold text-brand-primary">
                      Introducing Stroomcoins (SC)
                    </h3>
                  </div>
                  <p className="text-muted-foreground">
                    Our revolutionary digital currency powers the StroomUp
                    ecosystem. Earn SC by streaming, watching, and engaging. Use
                    them for premium features, creator tips, and exclusive
                    content.
                  </p>
                </div>
              </div>
